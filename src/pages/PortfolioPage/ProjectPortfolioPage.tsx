...
const COLORS = {
  primary: '#001F5C',
  accent: '#FFD700',
  backgroundDay: '#F1F5F9', // Slightly darker than pure white for depth
...
export const ProjectPortfolioPage: React.FC = () => {
  ...
  // SHARED STATE LOGIC: Sync with LocalStorage
  ...
  return (
    <div 
      ...
      id="portfolio" 
      style={{ backgroundColor: isNightOps ? COLORS.backgroundNight : COLORS.backgroundDay }}
    >
      {/* === MANUAL TOGGLE BUTTON (Synced) === */}
      <button
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <motion.h1 
            ...
            className="text-5xl sm:text-7xl font-black mb-4 tracking-tighter"
          ...
          <p className="text-xl mb-10 max-w-2xl mx-auto font-medium" 
             style={{ color: isNightOps ? '#94a3b8' : '#334155' }}>
          ...
          {filteredProjects.map((project, index) => (
            ...
            >
              ...
              <div 
                ...
                style={{ 
                  backgroundColor: isNightOps ? 'rgba(0, 8, 20, 0.95)' : 'white',
                  borderTop: isNightOps ? 'none' : `8px solid ${COLORS.primary}`,
                  boxShadow: isNightOps ? 'none' : '0 20px 40px rgba(0,0,0,0.08)'
                }}
              >
                <div 
                  className="h-52 flex items-center justify-center relative overflow-hidden grayscale group-hover:grayscale-0 transition-all duration-700"
                  style={{ backgroundColor: COLORS.primary }}
                >
                  <span className="text-white text-xs font-black uppercase tracking-widest z-10">Project #{project.id}</span>
                ...
                <div className="p-8">
                  ...
                  <p className="text-sm mb-6 font-semibold" style={{ color: isNightOps ? '#64748b' : '#475569' }}>
                    <span className="font-black uppercase text-[10px] tracking-widest mr-2 px-2 py-1 rounded bg-yellow-400/10" 
                          style={{ color: COLORS.accent }}>Focus</span>
                    {project.skills.join(' | ')}
                  </p>
